...
const ServicesNavigation = ({ visible }: { visible: boolean }) => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 md:px-12">
        <Link to="/services" className="relative flex items-center">
          ...
          <span className="ml-3 text-sm font-semibold text-foreground">
            Lacuna Digital <span className="text-muted-foreground font-normal">| Services</span>
          </span>
        </Link>
