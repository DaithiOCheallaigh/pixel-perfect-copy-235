...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      { src: "/images/spotify/Spotify.webp", alt: "Spotify integration concept" },
      { src: "/images/spotify/Group-7.webp", alt: "Placement options" },
      { src: "/images/spotify/Group-12.webp", alt: "Spotify UI placement", wide: true },
      { src: "/images/spotify/SpotifyHeader_Web.webp", alt: "Tipping flow desktop", wide: true },
      { src: "/images/spotify/SpotifyHeader_Mobile.webp", alt: "Tipping flow mobile" },
    ],
